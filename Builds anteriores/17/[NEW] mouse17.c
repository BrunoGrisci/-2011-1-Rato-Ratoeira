...
void imprimequeijos (TIPO_QUEIJO *queijos, RATO *rat, RATOEIRA *ratoeira, GAME *game, int n);
...
int main (){
    ...
    imprimequeijos (queijos1,&rato,ratoeiras1,&game,LIMQ1);
    cutscene2();
    nivel(&rato,queijos2,LIMQ2,"NIVEL 02","nivel2.txt");
    imprimequeijos (queijos2,&rato,ratoeiras2,&game,LIMQ2);
    cutscene3();
    nivel(&rato,queijos3,LIMQ3,"NIVEL 03", "nivel3.txt");
    imprimequeijos (queijos3,&rato,ratoeiras3,&game,LIMQ3);
    ...
    do
    {
        if (queijos[i].visivel == 1) {
                ...
                if (!morte)
                {
                    ...
                    printfloat(72,14,BRANCOBRILHANTE,(*game).pontuacao);
                    i++;
