...
int main (){
    ...
    TIPO_QUEIJO queijos1[10] = {{0,0,0,5,AMARELOCLARO,{0,0},{}},
                                {0,0,0,3,AMARELOCLARO,{0,0},{}},
                                {0,0,0,2,AMARELOCLARO,{0,0},{}},
                                {0,0,0,9,AMARELOCLARO,{0,0},{}},
                                {0,0,0,1,AMARELOCLARO,{0,0},{}},
                                {0,0,0,7,AMARELOCLARO,{0,0},{}},
                                {0,0,0,4,AMARELOCLARO,{0,0},{}},
                                {0,0,0,8,AMARELOCLARO,{0,0},{}},
                                {0,0,0,6,AMARELOCLARO,{0,0},{}},
                                {0,0,0,10,AMARELOCLARO,{0,0},{}}};

    TIPO_QUEIJO queijos2[15] = {{0,0,0,7,AMARELOCLARO,{0,0},{}},
                                {0,0,0,1,AMARELOCLARO,{0,0},{}},
                                {0,0,0,2,AMARELOCLARO,{0,0},{}},
                                {0,0,0,8,AMARELOCLARO,{0,0},{}},
                                {0,0,0,6,AMARELOCLARO,{0,0},{}},
                                {0,0,0,10,AMARELOCLARO,{0,0},{}},
                                {0,0,0,9,AMARELOCLARO,{0,0},{}},
                                {0,0,0,13,AMARELOCLARO,{0,0},{}},
                                {0,0,0,3,AMARELOCLARO,{0,0},{}},
                                {0,0,0,5,AMARELOCLARO,{0,0},{}},
                                {0,0,0,15,AMARELOCLARO,{0,0},{}},
                                {0,0,0,14,AMARELOCLARO,{0,0},{}},
                                {0,0,0,11,AMARELOCLARO,{0,0},{}},
                                {0,0,0,12,AMARELOCLARO,{0,0},{}},
                                {0,0,0,4,AMARELOCLARO,{0,0},{}}};

    TIPO_QUEIJO queijos3[16] = {{0,0,0,6,AMARELOCLARO,{0,0},{}},
                                {0,0,0,8,AMARELOCLARO,{0,0},{}},
                                {0,0,0,10,AMARELOCLARO,{0,0},{}},
                                {0,0,0,2,AMARELOCLARO,{0,0},{}},
                                {0,0,0,7,AMARELOCLARO,{0,0},{}},
                                {0,0,0,16,AMARELOCLARO,{0,0},{}},
                                {0,0,0,12,AMARELOCLARO,{0,0},{}},
                                {0,0,0,5,AMARELOCLARO,{0,0},{}},
                                {0,0,0,1,AMARELOCLARO,{0,0},{}},
                                {0,0,0,9,AMARELOCLARO,{0,0},{}},
...
void nivel1(TIPO_QUEIJO *queijos) {
    ...
    char valor[2] = {};
    FILE *arq1;
    printcolor (71, 3, BRANCO, "NIVEL 01");
    ...
    do{
            ...
            for (i=0, j=2; i<22; i++, j++)
            {
                ...
                for (k=0, t=2, z=0; k<66; k++, t++)
                {
                    if ((fase[k]!= ' ') && (fase[k]!= '\n'))
                    {
                        ...
                        queijos[z].posicao.xy[0] = t;
                        queijos[z].posicao.xy[1] = j;
                        z++;

                        gotoxy (5,11);
                        printf ("%d", queijos[z].valor);
                        Sleep(1000);

                        cleanline(9);
                        cleanline(11);

                        //gotoxy(queijos[z].posicao.xy[0], queijos[z].posicao.xy[1]);
                        //printf ("%d", queijos[z].valor);
                        //Sleep(500);
        ...
        //printcolor (2,j,AMARELOCLARO, fase); //APAGAR
